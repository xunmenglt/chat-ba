        ...
        if model_name in ONLINE_LLM_MODEL:
            if "qianfan" in model_name:
                model = QianfanChatEndpoint(
                    ...
                    qianfan_ak=ONLINE_LLM_MODEL[model_name]["qianfan_ak"],
                    qianfan_sk=ONLINE_LLM_MODEL[model_name]["qianfan_sk"],
                    **kwargs
                )
            ...
            model = ChatOpenAI(
                ...
                openai_api_base=get_faschat_server_open_api(),
                model_name=model_name,
                temperature=temperature,
                top_p=top_p,
                max_tokens=max_tokens,
